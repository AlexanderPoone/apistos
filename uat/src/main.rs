...
pub(crate) async fn testConnection(body: Json<>) {
  Ok(Json())
}
pub(crate) async fn signIn_github(body: Json<>) {
  Ok(Json())
}
pub(crate) async fn signIn_google(body: Json<>) {
  Ok(Json())
}
pub(crate) async fn signUp(body: Json<>) {
  Ok(Json())
}
pub(crate) async fn confirmAccount(body: Json<>) {
  Ok(Json())
}
pub(crate) async fn signIn(body: Json<>) {
  Ok(Json())
}
pub(crate) async fn signOut(body: Json<>) {
  Ok(Json())
}
pub(crate) async fn requestChangePassword(body: Json<>) {
  Ok(Json())
}
pub(crate) async fn changePasswordWithToken(body: Json<>) {
  Ok(Json())
}
pub(crate) async fn setAccountSetting(body: Json<>) {
  Ok(Json())
}
pub(crate) async fn getBlogs(body: Json<>) {
  Ok(Json())
}
pub(crate) async fn getProjects(body: Json<>) {
  Ok(Json())
}
pub(crate) async fn converted(body: Json<>) {
  Ok(Json())
}
*/